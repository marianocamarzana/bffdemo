package com.aws.lambda.exception.handler;
...
@Component
public class UserAPIExceptionHandler extends AbstractErrorWebExceptionHandler {


    public UserAPIExceptionHandler(ErrorAttributes errorAttributes, WebProperties.Resources resources,
